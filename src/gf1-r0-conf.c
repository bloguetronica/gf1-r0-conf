/* GF1 Rev. 0 Configuration Program - Version 1.0 for Debian Linux
...
// Function prototypes
bool is_otp_blank(libusb_device_handle *);
void lock_otp(libusb_device_handle *);
void reset(libusb_device_handle *);
void write_mfg_str1(libusb_device_handle *);
void write_mfg_str2(libusb_device_handle *);
void write_pin_cfg(libusb_device_handle *);
void write_prd_str1(libusb_device_handle *);
void write_prd_str2(libusb_device_handle *);
void write_ser_str(libusb_device_handle *, char *);
void write_usb_cfg(libusb_device_handle *);
...
int main(void)
{
    ...
    {
        devhandle = libusb_open_device_with_vid_pid (context, 0x10C4, 0x87A0);  // Open a device and get the device handle
...
{
    unsigned char control_buf_out[64] = {
        0x30, 0x03, 0x47, 0x00, 0x46, 0x00, 0x31, 0x00,  // GF1 Function Generator
        0x20, 0x00, 0x46, 0x00, 0x75, 0x00, 0x6E, 0x00,
        0x63, 0x00, 0x74, 0x00, 0x69, 0x00, 0x6F, 0x00,
        0x6E, 0x00, 0x20, 0x00, 0x47, 0x00, 0x65, 0x00,
...
{
    unsigned char control_buf_out[64] = {
        0x1C, 0x03, 0x47, 0x00, 0x46, 0x00, 0x31, 0x00,  // GF1-00xxxxxx
...
void write_usb_cfg(libusb_device_handle *devhandle)  // Writes the USB configuration values into the OTP ROM
{
    unsigned char control_buf_out[10] = {
        ...
        0x7D, 0x8A,  // PID is 0x8A7D
        0x64,        // Maximum power is 200mA (0x64)
